...
if torch._C._has_mkldnn:
    ...
    def _is_valid_computation_binary(computation_op, binary_op, other_index=None) -> bool:
        def fn(match):
    ...
    def _is_valid_computation_binary_inplace(computation_op, binary_op, other_index) -> bool:
        def fn(match):
